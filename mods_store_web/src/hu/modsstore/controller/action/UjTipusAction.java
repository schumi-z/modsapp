...
public class UjTipusAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		/*if (tipus.getNev() == null || tipus.getNev().length() == 0) {
		...
		try {
			((TermekService)SpringUtil.getBean("termekService")).create(tipus);
		} catch (Exception e) {
			request.setAttribute("message", "M\u00e1r l\u00e9tezik ilyen nev\u0171 t\u00edpus.");
			return mapping.findForward("error");
		}
